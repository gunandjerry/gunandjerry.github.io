...
function Introduction({ id, personalInfo }) {
  ...
  return (
    <section id={id} className="py-8 sm:py-14 bg-slate-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-2/3 text-center md:text-left">
          ...
          <p className="text-lg sm:text-xl text-slate-300 leading-relaxed">
            ...
            {/* '빠른 성장'과 '꾸준함'은 저의 가장 강력한 무기입니다.<br></br>무엇을 시켜주셔도 끝까지 매달려 완성도를 갖춘 결과물을 만들어보이겠습니다. */}
            호감을 주는 태도와 상상을 구현해내는 센스가 저의 가장 강력한 무기입니다.<br></br>
            맡은 일을 무엇보다 우선하는 태도로 늘 완성도를 갖춘 결과물을 보여드리겠습니다!
          </p>
